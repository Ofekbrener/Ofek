...
export const LEAGUES = [
  {
    ...
    tracks: [
      { id: 'coop-loop', name: 'Coop Loop', seed: 11, theme: 0, laps: 1, radius: 300, twist: 0.35, hills: 6, obstacles: 6, pads: 6 , power: 1, features: ['rocks'], intro: { icon: '🕹️', title: 'Learn to steer', text: 'Hold ◀ ▶ (or drag) to steer. Corners push you toward the wall — steer into them!' }, rival: 0.95 },
      { id: 'yolk-speedway', name: 'Yolk Speedway', seed: 23, theme: 1, laps: 1, radius: 320, twist: 0.45, hills: 10, obstacles: 8, pads: 7 , power: 2, features: ['rocks', 'boost'], intro: { icon: '⚡', title: 'NEW: Boost', text: 'Drive over boost pads to charge energy, then tap BOOST for a burst of speed.' }, rival: 1.05 },
      { id: 'scrambled', name: 'Scrambled Circuit', seed: 37, theme: 0, laps: 1, radius: 290, twist: 0.6, hills: 8, obstacles: 9, pads: 6 , power: 3, features: ['rocks', 'boost', 'items'], intro: { icon: '🥚', title: 'NEW: Egg Missiles', text: 'Grab ? boxes on the track. Tap ITEM to fire a homing egg at the racer ahead.' }, rival: 1.14 },
    ],
  },
  {
    id: 'pro',
    ...
    tracks: [
      ...
      { id: 'frostbite', name: 'Frostbite Raceway', seed: 64, theme: 3, laps: 2, radius: 180, twist: 0.7, hills: 14, obstacles: 12, pads: 7 , power: 6, features: ['rocks', 'boost', 'items', 'draft', 'rivalItems', 'ice', 'shield'], intro: { icon: '🧊', title: 'NEW: Ice & Shields', text: 'Blue ice patches kill your grip. ? boxes can now give a Shield that blocks one hit.' }, rival: 1.26 },
      { id: 'drumstick-drift', name: 'Drumstick Drift', seed: 78, theme: 1, laps: 2, radius: 190, twist: 0.85, hills: 10, obstacles: 12, pads: 8 , power: 8, features: ['rocks', 'boost', 'items', 'draft', 'rivalItems', 'ice', 'shield', 'drift'], intro: { icon: '🌀', title: 'NEW: Drift Turbo', text: 'Hold a hard turn through a corner to charge a mini-turbo — it fires when you straighten out.' }, rival: 1.32 },
    ],
  },
  {
    id: 'grand',
    ...
    tracks: [
      { id: 'omelette-ring', name: 'Omelette Ring', seed: 91, theme: 4, laps: 2, radius: 220, twist: 0.8, hills: 16, obstacles: 14, pads: 8 , power: 10, features: ['rocks', 'boost', 'items', 'draft', 'rivalItems', 'ice', 'shield', 'drift', 'rollingEggs', 'mine'], intro: { icon: '💣', title: 'NEW: Rolling Eggs & Mines', text: 'Giant eggs roll across the track. ? boxes can give an Egg Mine to drop behind you.' }, rival: 1.38 },
      { id: 'feather-storm', name: 'Feather Storm GP', seed: 104, theme: 3, laps: 2, radius: 200, twist: 0.95, hills: 18, obstacles: 15, pads: 8 , power: 12, features: ['rocks', 'boost', 'items', 'draft', 'rivalItems', 'ice', 'shield', 'drift', 'rollingEggs', 'mine', 'wells', 'chicanes'], intro: { icon: '🌌', title: 'NEW: Gravity Wells', text: 'Purple wells tug your ship sideways, and chicanes squeeze the track. Stay sharp!' }, rival: 1.44 },
