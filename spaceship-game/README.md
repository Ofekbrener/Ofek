...
- **Coco Catapult** (Home → Catapult): an Angry-Birds-style 3D physics puzzler (cannon-es) seen from behind the slingshot. Pull back to aim with a dotted arc, let go to launch Coco's pod (with your upgrades and add-ons) into wood, stone and ice towers full of Space Hens; tap mid-flight to dive. 15 levels across 3 worlds with stars (par shots), drumstick rewards, a boss per world and a cosmetic prize for clearing each world.
